/**
 * @page libcameracontrolptp The document of the libcameracontrolptp part
 * @section abstract Abstract
 * libcameracontrolptp is a sample library to perform PTP/USB connection and PTP
transfer.\n
...
libcameracontrolptp with your backends.
 *
 * @section guide Porting guide
 * libcameracontrolptp has device handling, synchronous transaction, hotplug detection
methods.\n
 * \n
...
.socc_types.h
 * In our sample, libcameracontrolptp detects hotplug event after calling connect() method
 ...
 * In our sample, libcameracontrolptp clears BULK IN, BULK OUT and Interrupt IN endpoints
 ...
 * In our sample, libcameracontrolptp just call reset function of backend.\n
 * \n
 */

/**
 * @file socc_ptp.h
 * @brief libcameracontrolptp class
 */
