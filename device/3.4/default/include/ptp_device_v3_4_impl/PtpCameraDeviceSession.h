...
#ifndef ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_PTPCAMERADEVICESESSION_H
#define ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_PTPCAMERADEVICESESSION_H
...
using ::android::hardware::camera::ptp::common::SizeHasher;
...
struct PTPCameraDeviceSession : public virtual RefBase,
        public virtual OutputThreadInterface {

    PTPCameraDeviceSession(const sp<ICameraDeviceCallback>&,
    ...
    virtual ~PTPCameraDeviceSession();
    ...
    static const int kMaxProcessedStream;
    static const int kMaxStallStream;
    static const uint32_t kMaxBytesPerPixel;
...
protected:
    ...
    int configurePTPStreamLocked(const SupportedPTPFormat& fmt, double fps = 0.0);
    int ptpStreamOffLocked();
    ...
    sp<PTPFrame> dequeuePTPFrameLocked(/*out*/nsecs_t* shutterTs); // Called with mLock hold
    void enqueuePTPFrame(const sp<PTPFrame>&);
    ...
    const common::V1_0::helper::CameraMetadata mCameraCharacteristics;
    const std::vector<SupportedPTPFormat> mSupportedFormats;
    const CroppingType mCroppingType;
    ...
    bool mPtpStreaming = false;
    SupportedPTPFormat mPtpStreamingFmt;
...
private:
    ...
    struct TrampolineSessionInterface_3_4 : public ICameraDeviceSession {
        TrampolineSessionInterface_3_4(sp<PTPCameraDeviceSession> parent) :
                mParent(parent) {}
    ...
    private:
        sp<PTPCameraDeviceSession> mParent;
    };
};
...
#endif  // ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_PTPCAMERADEVICESESSION_H
